...
CougarGrades has been re-written from [Next.js](https://nextjs.org/) web app that ran on [Vercel](https://vercel.com/) to:
...
Since version 1.0.0 circa 2020, CougarGrades has been a .
